...
autoketik = false;
prefixStatus = true;
targetpc = "6285854721440"; 
owner = "6285854721440"; 
fakeyoi = "PutraGanzz シ︎"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6285854721440@s.whatsapp.net`]
...
/*const reply = (teks) => {
			itsmevall.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6283162388082?text=Assalamualaikum`}}})
		}*/
...
if (!itsMe && !isOwner)return 
    ...
    const ftokoo = {
      key: {
        fromMe: false,
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "6285854721440@s.whatsapp.net" } : {}),
      },
      message: {
        productMessage: {
          product: {
            ...
            title: "PutraGanzz", //Kasih namalu
            description: "PUTTBOTZ",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "PutraGanzz",
            productImageCount: 1,
          },
...
// Katalog
const reply = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*PutraGanzz*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             itsmevall.relayWAMessage(res)
        }
const fakewa = (teks) => {        
itsmevall.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6283162388082?text=Assalamualaikum`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nNDAABOTZ. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6285854721440`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6285854721440`,
                "thumbnailUrl": "https://j.top4top.io/p_20682m4yj0.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6285854721440`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "6285854721440@s.whatsapp.net";
...
await itsmevall.setStatus(`Sedang Menunggumu Selama\n ${uptime}`).catch((_) => _);
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz︎', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Terimakasih Telah Terdaftar NdaaBotz*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hai ${pushname}\n ${ucapanWaktu} Kak 👋`
               ...
               buttonText:{displayText: 'MENU シ︎'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER シ︎'},type:1},
               {buttonId:`${prefix}command`,buttonText:{displayText:'LISTMENU シ︎'},type:1}]
...
groups = itsmevall.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "6285854721440@s.whatsapp.net"
        dtod = '6285854721440'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
case 'bugreport':
              ...
              itsmevall.sendMessage('6285854721440@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               sendKontak(from, `${owner}`, `${fakeyoi}`, 'Sedang Cari janda!!')
               await sleep(1000)
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/c/PutraGanzz"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        itsmevall.toggleDisappearingMessages(from, 0)
...
itsmevall.sendMessage(from,'Ini Kontak Owner Ku\nEmng Mau Diapain Owner Ku?',text,{quoted: mek})
break
case 'command':
case 'cmd':
case 'listmenu':
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz シ︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}kickarea
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz︎`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
㋛${prefix}upswlokasi
`
sendButMessage(from, menu, ` 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
              displayText: `⬡ BACK TO MENU `,
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz"
    }
  }, {quoted: freply})
...
case 'script':
		case 'sc':
		case 'sourcecode':
		itsmevall.sendMessage(from, { text: "https://github.com/PUTRA-gblk", matchedText: 'nopee', description: "", title: "Ngapain Om?", jpegThumbnail: iye }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
      //------------------< Sticker Cmd >-------------------
      case "addcmd":
      case "setcmd":
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "https://github.com/PUTRA-gblk"
        },
        "index": 0
      }
    ]
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz︎', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @𝙣𝙣𝙙𝙖.𝙠𝙧𝙬𝙣_ ☹︎`,buttons,headerType:4}
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz︎`, [
            {              
...
itsmevall.sendMessage(_.jid, 
			...
			"footerText": '𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz︎',
			"buttons": [
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz︎', imageMessage: imageMsg,
              contentText:`Nih Kak:v 😗 ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
case 'anal':
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 PutraGanzz', imageMessage: imageMsg,
              contentText:`Nih Kak:v 😗 ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
...
case 'listnulis':
  ...
  🌹 ${prefix}nulis PutraGanzz
  🌹 ${prefix}foliokanan PutraGanzz
  🌹 ${prefix}foliokiri PutraGanzz
  🌹 ${prefix}nuliskanan PutraGanzz
  🌹 ${prefix}nuliskiri PutraGanzz`)
  break
case 'foliokiri':
if (!c) return reply('Textnya mana gan?')
reply(mess.wait)
